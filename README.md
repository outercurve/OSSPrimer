...
* The http://asciidoc.org/[_Official Ascii Doc site_]. This site contains references, cheat sheets, templates, and how-to documentation on installing and running the tool chain (asciiidoc.py, et al). Of particular use: 
